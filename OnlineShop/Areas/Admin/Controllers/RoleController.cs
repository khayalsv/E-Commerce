...
namespace OnlineShop.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public IActionResult Assign()
        {
            ...
            ViewData["UserId"] = new SelectList(_db.AppUsers.Where(f => f.LockoutEnd < DateTime.Now || f.LockoutEnd == null).ToList(), "Id", "UserName");
        ...
        {
            var user = _db.AppUsers.FirstOrDefault(c => c.Id == roleUser.UserId);
        ...
        public ActionResult AssignUserRole()
        {
            var result = from ur in _db.UserRoles
                         ...
                         join a in _db.AppUsers on ur.UserId equals a.Id
